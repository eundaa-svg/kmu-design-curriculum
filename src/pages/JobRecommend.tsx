...
export default function JobRecommend() {
  ...
  const recommendedCourses = useMemo(() => {
    ...
    // Collect all (courseId, relevance) pairs from selected jobs
    ...
    for (const mapping of jobCourseMappings) {
      ...
      // Upgrade to core if any selected job marks it core
    ...
    // Sort: core first, then by year asc, then credits desc
    results.sort((a, b) => {
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, color: '#888888', marginTop: 8 }}>
            관심있는 직군을 선택하면 추천 수업을 알려드려요. 타과 수업도 포함됩니다.
          </p>
        </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {!isMyDept && (
                          <span style={{ fontSize: 11, color: '#888888' }}>타과</span>
                        )}
                      </div>
