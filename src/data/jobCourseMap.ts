...
export const jobCourseMappings: JobCourseMapping[] = [
  ...
  { jobId: 'motion', courseId: 'mi-308', relevance: 'related' },
  { jobId: 'motion', courseId: 'mi-209', relevance: 'related' },
  ...
  // ===== 공간 디자이너 =====
  { jobId: 'space', courseId: 'sd-302', relevance: 'core' },
  { jobId: 'space', courseId: 'sd-309', relevance: 'core' },
  { jobId: 'space', courseId: 'sd-305', relevance: 'core' },
